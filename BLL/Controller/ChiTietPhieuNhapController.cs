...
namespace CuahangNongduoc.Controller
{
    public class ChiTietPhieuNhapController
    {
        private readonly ChiTietPhieuNhapDAL _dal = new ChiTietPhieuNhapDAL();  // giống M1 dùng DAL, không Factory
        ...
        /* ===================== BINDING HIỂN THỊ ===================== */
        public void HienThiChiTiet(ListView lvw, string idPhieuNhap)
        {
            var tbl = _dal.LayChiTietPhieuNhap(idPhieuNhap);
